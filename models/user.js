...
class User {
   ...
   *   where jobs is an array of jobs applied to [jobId, jobId... ]
   *
  ...
  /** Given a username and jobId, creates new entry in table "applications"
   *  
   *  username: of user applying to a job
